...
__all__ = [
    'DISPID_SLPsItem', 'DISPID_SGRAddState', 'DISPID_SVSpeakStream',
    'DISPID_SpeechMemoryStream', 'SGDSActiveWithAutoPause',
    'DISPID_SGRAttributes', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPINTERFERENCE_TOOSLOW', 'ISpeechPhraseElements',
    'SDKLLocalMachine', 'SBONone', 'SPCT_COMMAND', 'DISPID_SLWsItem',
    'DISPID_SpeechLexiconWords', 'DISPID_SVEStreamEnd',
    'DISPID_SBSRead', 'DISPID_SLWsCount', 'DISPID_SLPPhoneIds',
    'SVP_11', 'DISPID_SDKSetStringValue', 'ISpeechMMSysAudio',
    ...
    'DISPID_SGRSTs_NewEnum', 'DISPID_SBSWrite', 'SPFM_NUM_MODES',
    'DISPID_SpeechPhraseRule', 'SPRST_INACTIVE', 'DISPID_SMSGetData',
    'DISPID_SLWType', 'SpAudioFormat', 'ISpStreamFormat',
    ...
    'DISPID_SMSSetData', 'SpeechStreamFileMode', 'DISPID_SGRSTWeight',
    'STSF_LocalAppData', 'SRERecognition', 'SREPrivate',
    '_SPAUDIOSTATE', 'SPRECOGNIZERSTATUS', 'SPDKL_CurrentUser',
    'SRCS_Disabled', 'ISpeechGrammarRuleStateTransitions',
    'ISpeechResourceLoader', 'DISPID_SRRGetXMLErrorInfo',
    'SWPKnownWordPronounceable', 'SPVPRI_OVER', 'DISPID_SGRsCount',
    'SPSHT_Unknown', 'DISPID_SRGDictationUnload',
    'DISPID_SRCEInterference', 'DISPID_SGRsItem',
    'DISPID_SPILanguageId', 'SPPARTOFSPEECH',
    'SpPhoneticAlphabetConverter', 'eLEXTYPE_RESERVED4',
    'SpeechPropertyNormalConfidenceThreshold',
    'IInternetSecurityManager', 'DISPID_SOTCategory',
    'SAFTCCITT_uLaw_22kHzMono', 'SPADAPTATIONRELEVANCE',
    'DISPID_SVSPhonemeId', 'DISPID_SOTDataKey',
    'DISPID_SVSInputWordPosition', 'SPEI_END_INPUT_STREAM',
    'SPSEMANTICFORMAT', 'DISPID_SPRsItem', 'SSFMCreateForWrite',
    'DISPID_SPRFirstElement', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SRGCmdLoadFromMemory', 'STCInprocServer', 'SVPOver',
    'SPAUDIOOPTIONS', 'SPRS_ACTIVE', 'ISpeechMemoryStream',
    'DISPID_SDKDeleteKey', 'DISPID_SVSLastBookmarkId',
    'SPDKL_CurrentConfig', 'SPAS_PAUSE', 'SPEI_MAX_SR', 'SPSUnknown',
    'SPPHRASEREPLACEMENT', 'SPGRAMMARWORDTYPE', 'SECFIgnoreCase',
    'SPCS_ENABLED', 'SVP_19', '_ISpeechRecoContextEvents',
    'DISPID_SOTsItem', 'DISPID_SMSADeviceId', 'DISPID_SMSALineId',
    'SPINTERFERENCE_TOOLOUD', 'STSF_FlagCreate', 'SP_VISEME_1',
    'DISPID_SLGetPronunciations', 'SAFT48kHz8BitMono',
    'SPSHT_NotOverriden', 'SAFT16kHz8BitStereo',
    'SpCompressedLexicon', 'ISpNotifySink',
    'DISPID_SOTCreateInstance', 'ISpeechPhraseAlternate',
    'SAFTGSM610_22kHzMono', 'SRSActive', 'DISPID_SRRTTickCount',
    'SpeechRetainedAudioOptions', 'ISpeechPhoneConverter',
    'DISPID_SVGetVoices', 'SRERecoOtherContext', 'eLEXTYPE_PRIVATE5',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPIGetText',
    'DISPID_SRGRecoContext', 'DISPIDSPTSI_ActiveLength',
    'SPVPRI_ALERT', 'SAFT48kHz16BitStereo', 'DISPID_SMSAMMHandle',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SRSSupportedLanguages',
    'SPWORDLIST', 'DISPID_SOTCGetDataKey', 'SPEI_RESERVED6',
    'DISPID_SpeechVoiceStatus', 'DISPID_SLWPronunciations',
    'DISPID_SGRSTRule', 'ISpRecoContext2',
    'DISPID_SPERetainedSizeBytes', 'SPRULESTATE',
    'Speech_StreamPos_Asap', 'SPINTERFERENCE_NONE',
    'DISPID_SGRsDynamic', 'DISPID_SRDisplayUI',
    'DISPID_SRGIsPronounceable', 'DISPID_SVSRunningState',
    'DISPID_SRCRequestedUIType', 'SSFMOpenForRead', 'SPPS_Noncontent',
    'DISPID_SWFEBlockAlign', 'DISPID_SPAs_NewEnum',
    'SpeechPropertyResponseSpeed', 'SVF_Stressed', 'DISPID_SRGRules',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SVWaitUntilDone',
    'DISPID_SVGetAudioInputs', 'DISPID_SRCVoice', 'SREAdaptation',
    'DISPID_SRProfile', '__MIDL_IWinTypes_0009',
    'ISpeechXMLRecoResult', 'SPWT_DISPLAY',
    ...
    'DISPID_SLGetWords', 'SP_VISEME_0', 'SPWORDPRONUNCIATION',
    'SPBO_TIME_UNITS', 'SpeechTokenKeyFiles', 'SAFT22kHz8BitMono',
    'DISPID_SPPName', 'SPPS_Verb', 'STSF_CommonAppData',
    'SPEI_TTS_AUDIO_LEVEL', 'SpeechRecoContextState',
    'DISPID_SpeechObjectTokenCategory',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SVEAudioLevel',
    'DISPID_SPRuleEngineConfidence', 'SAFTCCITT_ALaw_11kHzMono',
    'SSFMOpenReadWrite', 'SP_VISEME_9', 'ISpRecognizer2',
    'SGSExclusive', 'DISPID_SPANumberOfElementsInResult',
    'SPEVENTENUM', 'SSSPTRelativeToCurrentPosition', 'SVEAllEvents',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPRuleNumberOfElements',
    'SSSPTRelativeToEnd', 'SpeechUserTraining', 'eLEXTYPE_APP',
    'DISPID_SRCEHypothesis', 'SAFTCCITT_ALaw_44kHzMono',
    'SPAR_Medium', 'SVSFUnusedFlags', 'DISPID_SOTs_NewEnum',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SABIEventBias',
    'SPEI_RECO_STATE_CHANGE', 'SAFT8kHz16BitStereo',
    ...
    'SDKLCurrentUser', 'eLEXTYPE_PRIVATE2', 'SAFT44kHz8BitMono',
    'SP_VISEME_11', 'DISPID_SRCERecognition', 'STCRemoteServer',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRSCurrentStreamPosition',
    'SPEI_TTS_BOOKMARK', 'SRATopLevel', 'ISpXMLRecoResult',
    'DISPID_SpeechAudioFormat', 'DISPID_SABufferInfo',
    'SVEAudioLevel', 'SPWT_LEXICAL', 'Speech_Max_Pron_Length',
    'SpeechDictationTopicSpelling', 'SpeechAudioFormatGUIDWave',
    'SPBO_NONE', 'DISPIDSPTSI_ActiveOffset', 'DISPID_SVPriority',
    'DISPID_SPIGrammarId', 'DISPID_SpeechRecognizer',
    'SPEI_SR_AUDIO_LEVEL', 'SPEI_PHRASE_START', 'DISPID_SPPsCount',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SRRAudio', 'SPBO_AHEAD',
    'SAFTADPCM_22kHzMono', 'SpMemoryStream', 'DISPID_SpeechDataKey',
    'SPPHRASERULE', 'DISPID_SRCCreateGrammar', 'DISPID_SpeechVoice',
    'SVSFPurgeBeforeSpeak', 'DISPID_SDKOpenKey',
    'DISPID_SPARecoResult', 'ISpProperties', 'SP_VISEME_12',
    'SP_VISEME_16', 'DISPID_SDKSetLongValue',
    'SpeechVoiceCategoryTTSRate', 'SAFT11kHz8BitMono',
    'SAFTCCITT_uLaw_8kHzMono', 'SGRSTTEpsilon', 'eLEXTYPE_USER',
    'SPEI_PHONEME', 'SAFT8kHz16BitMono',
    'DISPID_SRCAudioInInterferenceStatus', 'eLEXTYPE_PRIVATE14',
    'DISPID_SDKGetStringValue', 'DISPID_SVAlertBoundary',
    'SREAudioLevel', 'eLEXTYPE_PRIVATE16', 'SP_VISEME_2',
    'SGRSTTRule', 'DISPID_SFSOpen', 'DISPID_SWFEBitsPerSample',
    'ISpEventSink', 'SVSFNLPMask', 'SpeechRecognitionType',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SPRuleConfidence',
    'SSSPTRelativeToStart', 'DISPID_SAStatus',
    'SPEI_START_INPUT_STREAM', 'SPCT_SLEEP',
    'DISPID_SRCCmdMaxAlternates', 'SPFM_CREATE',
    'DISPID_SPERequiredConfidence', 'IStream',
    'ISpeechTextSelectionInformation', 'DISPID_SRRecognizer',
    'DISPID_SRCRetainedAudio', 'SPPS_Noun',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SASFreeBufferSpace',
    'DISPID_SOTCEnumerateTokens', 'SVP_7', 'DISPIDSPTSI',
    'DISPID_SpeechPhraseBuilder', 'SVSFParseSsml', 'DISPID_SPPValue',
    'DISPID_SPCIdToPhone', 'SITooQuiet', 'DISPID_SGRSTType',
    'SpeechDisplayAttributes', 'SITooSlow',
    'SpeechSpecialTransitionType', 'DISPID_SPIRule',
    'SpeechTokenContext', 'DISPID_SRCEBookmark',
    'DISPID_SPAPhraseInfo', 'SpeechPartOfSpeech', 'SPSFunction',
    'SPEI_RECOGNITION', 'SpeechTokenIdUserLexicon',
    'SpInProcRecoContext', 'DISPID_SPELexicalForm',
    'SWPUnknownWordUnpronounceable',
    'DISPID_SpeechLexiconPronunciation', 'SDA_No_Trailing_Space',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SBSFormat',
    'SVSFNLPSpeakPunc', 'ISpRecoResult', 'SAFT44kHz8BitStereo',
    'DISPID_SRGCommit', 'SPLEXICONTYPE', 'SpeechGrammarTagDictation',
    'Speech_StreamPos_RealTime', 'SDA_One_Trailing_Space',
    'DISPID_SWFEFormatTag', 'ISpAudio', 'SpeechVisemeType',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SpeechRecognizerState',
    'DISPID_SpeechRecoContext', 'DISPID_SRGId', 'DISPID_SVPause',
    'DISPID_SOTRemove', 'SGRSTTWord', 'SLTUser', 'SPGS_DISABLED',
    'SAFT24kHz16BitStereo', 'DISPID_SGRSTNextState',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SRCEEnginePrivate',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRCPause', 'ISpeechRecoResult2',
    'SPEI_VISEME', 'SAFT32kHz8BitMono', 'SDTReplacement',
    'SAFTADPCM_44kHzMono', 'ISpeechRecoGrammar',
    'ISpStreamFormatConverter', 'DISPID_SGRSAddRuleTransition',
    'SPFM_OPEN_READWRITE', 'SAFTADPCM_8kHzStereo',
    'DISPID_SPEs_NewEnum', 'ISpEventSource', 'DISPID_SADefaultFormat',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpeechVisemeFeature',
    'SVEVoiceChange', 'DISPID_SPRsCount', 'ISpRecoGrammar',
    'DISPID_SLPPartOfSpeech', 'SAFT24kHz8BitStereo',
    'SpeechTokenKeyUI', 'SpUnCompressedLexicon', 'SP_VISEME_3',
    'SPAS_CLOSED', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPPFirstElement', 'SAFTCCITT_ALaw_8kHzMono',
    'SVEWordBoundary', 'SDTProperty', 'SVP_8', 'ISpRecoContext',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SpeechGrammarRules',
    'SPEI_SR_BOOKMARK', 'SPEI_RESERVED5', 'DISPID_SpeechObjectToken',
    'DISPID_SPIReplacements', 'DISPID_SGRSTPropertyName',
    'SAFT12kHz8BitMono', 'SVP_3', 'DISPID_SRGDictationSetState',
    'DISPID_SRCEPhraseStart', 'ISpeechRecoContext', 'SPAUDIOSTATE',
    'SPWORDTYPE', 'SP_VISEME_8', 'SRTReSent', 'eLEXTYPE_PRIVATE10',
    'SASStop', 'DISPID_SOTCSetId', 'DISPID_SOTId',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPPs_NewEnum',
    'SpeechWordType', 'DISPID_SGRsCommit',
    'SpeechAudioFormatGUIDText', 'DISPID_SVSLastStreamNumberQueued',
    'SPEI_SOUND_START', 'SAFT11kHz8BitStereo',
    'SpeechGrammarTagUnlimitedDictation', 'SPRECOSTATE',
    'SGLexicalNoSpecialChars', 'SPBOOKMARKOPTIONS', 'DISPID_SVResume',
    'eLEXTYPE_PRIVATE18', 'SRESoundEnd', 'SBOPause',
    'SREFalseRecognition', 'SRADefaultToActive',
    'ISpPhoneticAlphabetSelection', 'DISPID_SVSInputSentenceLength',
    'SPSInterjection', 'SDTDisplayText', 'SVESentenceBoundary',
    'DISPID_SPACommit', 'SpeechAudioFormatType', 'ISpDataKey',
    'SPSHT_OTHER', 'SpeechEngineConfidence', 'SpPhraseInfoBuilder',
    'DISPID_SGRInitialState', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SpeechAudioStatus', 'SpVoice', 'SAFT24kHz16BitMono',
    'SREAllEvents', 'SPDKL_DefaultLocation', 'SPSERIALIZEDPHRASE',
    'DISPID_SVRate', 'eLEXTYPE_RESERVED7',
    'DISPID_SPIEnginePrivateData', 'SDKLDefaultLocation',
    'SpObjectToken', 'ISpeechLexiconWord', 'SECNormalConfidence',
    'SPGRAMMARSTATE', 'SECFNoSpecialChars', 'SPEI_HYPOTHESIS',
    'SPGS_ENABLED', 'SpeechEngineProperties', 'SPDKL_LocalMachine',
    'DISPID_SWFEChannels', 'DISPID_SPRulesItem', 'SITooLoud',
    'SREBookmark', 'DISPID_SLPType', 'SpMMAudioOut',
    'DISPID_SPPEngineConfidence', 'DISPID_SRCreateRecoContext',
    'SREInterference', 'DISPID_SVSLastBookmark',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SLGenerationId',
    'DISPID_SGRSTsItem', 'DISPID_SPEAudioStreamOffset',
    'SpeechInterference', 'SpeechCategoryAudioIn',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'ISpShortcut',
    'SP_VISEME_15', 'DISPID_SRRPhraseInfo', 'SRERequestUI',
    'SPEI_TTS_PRIVATE', 'SRARoot', 'DISPID_SFSClose',
    'SPWAVEFORMATTYPE', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPIAudioSizeTime', 'DISPIDSPRG', 'SVP_13',
    'DISPID_SVSInputSentencePosition', 'SWPUnknownWordPronounceable',
    'ISpeechVoiceStatus', 'ISpeechRecoResultTimes',
    'eLEXTYPE_PRIVATE8', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SPRuleParent', 'SVP_21', 'SpeechDiscardType', 'SPEVENT',
    'DISPID_SRGCmdLoadFromFile', 'SGSEnabled',
    ...
    'SRAImport', 'ISpeechGrammarRuleState', 'SP_VISEME_18',
    'DISPID_SRCSetAdaptationData', 'eLEXTYPE_PRIVATE12',
    'DISPID_SpeechAudio', 'SPCONTEXTSTATE', 'SVP_16',
    'DISPID_SVEViseme', 'ISpeechPhraseRules', 'SRCS_Enabled',
    'SPCT_SUB_COMMAND', 'DISPID_SOTDisplayUI',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SVVolume', 'SP_VISEME_4',
    'DISPID_SRAudioInput', 'DISPID_SLAddPronunciation',
    'DISPID_SRCEPropertyNumberChange', 'ISpObjectTokenCategory',
    'DISPID_SGRs_NewEnum', 'SVPAlert', 'DISPID_SPPConfidence',
    'DISPID_SOTSetId', 'SPPS_Function', 'SpSharedRecoContext',
    'DISPID_SPEsItem', 'ISpeechGrammarRules', 'SpFileStream',
    'SVP_15', 'eLEXTYPE_PRIVATE19', 'DISPID_SVEBookmark',
    'SPFM_OPEN_READONLY', 'SAFTGSM610_11kHzMono', 'SPPS_RESERVED3',
    'ISpRecoCategory', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPRST_ACTIVE', 'SpeechVoiceSpeakFlags', 'SPSERIALIZEDRESULT',
    'SAFTDefault', 'ISpMMSysAudio', 'DISPID_SRRSaveToMemory',
    'SP_VISEME_17', 'SVP_0', 'SASRun', 'eLEXTYPE_RESERVED8',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SpeechWordPronounceable', 'eLEXTYPE_PRIVATE13',
    'SRSActiveAlways', 'SpeechRecoEvents', 'SPCATEGORYTYPE',
    'ISpeechGrammarRule', 'SREPropertyNumChange',
    'DISPID_SABIMinNotification', 'SFTSREngine',
    'eLEXTYPE_RESERVED10', 'DISPID_SpeechPhraseRules',
    'ISpeechObjectToken', 'DISPID_SLPSymbolic', 'ISpGrammarBuilder',
    'DISPID_SRCEFalseRecognition', 'DISPID_SpeechRecoContextEvents',
    'ISpeechAudioStatus', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPRules_NewEnum', 'SPAR_High', 'SGDSInactive',
    'SPWT_PRONUNCIATION', 'DISPID_SRCRetainedAudioFormat',
    'SAFT11kHz16BitStereo', 'ISpeechLexicon', 'SPSHORTCUTPAIR',
    'DISPID_SVSLastResult', 'SpResourceManager',
    'DISPID_SpeechRecoResult', 'SGRSTTTextBuffer', 'SRSEIsSpeaking',
    'DISPID_SPRuleName', 'SECHighConfidence', 'SpShortcut',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SRTAutopause', 'SPWORD',
    'SVSFParseSapi', 'SINoise', 'DISPID_SVEStreamStart',
    'DISPID_SVEWord', 'SPEI_RESERVED2', 'SpSharedRecognizer',
    'SVP_10', 'ISpeechRecognizerStatus', 'DISPID_SPRulesCount',
    'SPPHRASEPROPERTY', '_RemotableHandle',
    'DISPID_SPIAudioStreamPosition', 'SRTEmulated',
    'IEnumSpObjectTokens', 'SPEI_MIN_TTS', 'SPBINARYGRAMMAR',
    'SPPS_RESERVED1', 'DISPID_SWFEExtraData',
    'DISPID_SGRSTransitions', 'ISpeechObjectTokens',
    'DISPID_SPRuleChildren', 'SPLO_STATIC', 'SRAORetainAudio',
    'SSTTWildcard', 'DISPID_SpeechLexicon',
    'SpeechRegistryLocalMachineRoot', 'SAFTCCITT_ALaw_44kHzStereo',
    ...
    'SSTTTextBuffer', 'ISpeechVoice', 'DISPID_SVStatus',
    'DISPID_SAFGetWaveFormatEx', 'SAFTNonStandardFormat',
    'DISPID_SAEventHandle', 'SpeechLoadOption',
    'DISPID_SOTGetAttribute', 'SPDATAKEYLOCATION',
    'SPXRO_Alternates_SML', 'SPPS_RESERVED2', 'DISPID_SRRTLength',
    'DISPID_SRAudioInputStream', 'SVP_9', 'ISpeechPhraseReplacement',
    'SPVISEMES', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SRCEventInterests', 'ISpeechRecoResultDispatch',
    'DISPID_SGRSTText', 'SAFT16kHz16BitMono', 'SPAR_Unknown',
    'DISPID_SASNonBlockingIO', 'SpCustomStream', 'SAFT8kHz8BitStereo',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPEVENTSOURCEINFO',
    'DISPID_SOTsCount', 'SDKLCurrentConfig', 'SpeechRuleState',
    'SPEI_SENTENCE_BOUNDARY', 'SpInprocRecognizer',
    'SpeechBookmarkOptions', 'SPXRO_SML', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SpeechAudioBufferInfo', 'SAFT11kHz16BitMono', 'SPSLMA',
    'SECFIgnoreKanaType', 'DISPID_SRCState', 'SPCS_DISABLED',
    'SP_VISEME_19', 'DISPID_SPPChildren', 'SP_VISEME_21',
    'DISPID_SPRs_NewEnum', 'SPEI_WORD_BOUNDARY', 'SRAExport',
    'SpeechAllElements', 'DISPID_SPIEngineId',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SAFType', 'DISPID_SRState',
    'DISPID_SLPs_NewEnum', 'SPRS_INACTIVE',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRGReset',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRGDictationLoad',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SPRuleFirstElement',
    'ISpeechLexiconPronunciations', 'DISPID_SRCResume',
    'SPXMLRESULTOPTIONS', 'SRSInactiveWithPurge',
    'SAFT16kHz16BitStereo', 'DISPID_SPAsItem',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpeechAudioFormat',
    ...
    'DISPID_SRRRecoContext', 'DISPID_SRCRecognizer',
    'SAFT48kHz16BitMono', 'DISPID_SRRSetTextFeedback', 'SLODynamic',
    'DISPID_SPRText', 'SAFT22kHz16BitMono',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPFILEMODE',
    'DISPID_SDKGetlongValue', 'SGSDisabled', 'eLEXTYPE_PRIVATE7',
    'DISPID_SBSSeek', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'ISpPhoneticAlphabetConverter', 'SFTInput',
    'SAFTNoAssignedFormat', 'SPWORDPRONOUNCEABLE',
    'SPSEMANTICERRORINFO', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SpeechMMSysAudio', 'SGLexical', 'DISPID_SRStatus',
    'DISPID_SpeechPhraseAlternates', 'ISpRecognizer',
    'SpeechTokenShellFolder', 'SASPause', 'SPEI_START_SR_STREAM',
    'SGPronounciation', 'DISPID_SPIElements', 'DISPID_SASetState',
    'DISPID_SpeechPhraseProperties', 'SpeechAudioVolume',
    'SP_VISEME_20', 'SAFTCCITT_ALaw_8kHzStereo', 'SAFT44kHz16BitMono',
    'ISpeechCustomStream', 'ISpeechPhraseElement', 'SVP_6',
    'ISpPhoneConverter', 'ISpeechPhraseProperties',
    'Speech_Max_Word_Length', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SLGetGenerationChange', 'SVP_14', 'SPGS_EXCLUSIVE',
    'ISequentialStream', 'DISPID_SPAStartElementInResult',
    'DISPID_SPEDisplayAttributes', 'DISPID_SpeechPhraseReplacements',
    'ISpeechPhraseProperty', 'SP_VISEME_13', 'SPSSuppressWord',
    'SPRST_NUM_STATES', 'DISPID_SPIAudioSizeBytes', 'SREStreamStart',
    'SpNullPhoneConverter', 'SP_VISEME_6', 'SPWF_INPUT',
    'DISPID_SVEventInterests', 'SREStateChange', 'DISPID_SRGState',
    'DISPID_SPEAudioTimeOffset', 'SpStreamFormatConverter',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SpeechPhraseProperty',
    'DISPID_SpeechPhraseAlternate', 'SPRS_ACTIVE_USER_DELIMITED',
    'SpNotifyTranslator', 'SLOStatic', 'SPPHRASE', 'SPVOICESTATUS',
    'SVF_Emphasis', 'SP_VISEME_10', 'DISPID_SpeechPhraseElement',
    'DISPID_SVSkip', 'SPPS_RESERVED4', 'ISpVoice',
    'ISpResourceManager', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'ISpeechLexiconPronunciation', 'DISPID_SPCPhoneToId',
    'eLEXTYPE_MORPHOLOGY', 'SVSFParseMask', 'SDTRule',
    'SRTSMLTimeout', 'SLTApp', 'SITooFast',
    'SpeechTokenKeyAttributes', 'ISpSerializeState', 'DISPID_SLWWord',
    'tagSPPROPERTYINFO', 'SpeechRegistryUserRoot',
    'SPRST_INACTIVE_WITH_PURGE', 'SVP_2',
    'DISPID_SRGetPropertyNumber', 'SpeechPropertyResourceUsage',
    'SVSFlagsAsync', 'SVEStartInputStream', 'SVEBookmark',
    'DISPID_SRSNumberOfActiveRules', 'SPEI_UNDEFINED',
    'eLEXTYPE_PRIVATE1', 'DISPID_SLWLangId', 'DISPID_SLPsCount',
    'SPEI_END_SR_STREAM', 'SAFT16kHz8BitMono',
    'DISPID_SLRemovePronunciation', 'SGRSTTWildcard',
    'SpeechStreamSeekPositionType', 'DISPID_SRGetFormat',
    'SAFT24kHz8BitMono', 'SECFEmulateResult', 'DISPID_SRSClsidEngine',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SASState',
    'SPWF_SRENGINE', 'SVSFIsFilename', 'UINT_PTR', 'STCAll',
    'SpeechGrammarTagWildcard', 'DISPID_SpeechRecoResult2',
    'SREPropertyStringChange', 'DISPID_SRCBookmark',
    'DISPID_SABufferNotifySize', 'eLEXTYPE_PRIVATE4',
    'DISPID_SLPLangId', 'SPEI_SOUND_END',
    'SpeechEmulationCompareFlags', 'ISpeechAudioBufferInfo',
    'SpeechCategoryRecoProfiles', 'SpPhoneConverter', 'SVSFDefault',
    'STSF_AppData', 'SpeechVoiceSkipTypeSentence',
    'SPSHORTCUTPAIRLIST', 'DISPID_SDKDeleteValue',
    'DISPID_SPEDisplayText', 'DISPID_SLAddPronunciationByPhoneIds',
    'WAVEFORMATEX', 'SDTLexicalForm', 'ISpLexicon', 'SPPS_Unknown',
    'SAFTGSM610_44kHzMono', 'DISPID_SOTCId', 'SPSTREAMFORMATTYPE',
    'DISPID_SRGetPropertyString', 'SPLOADOPTIONS',
    'SPAO_RETAIN_AUDIO', 'SRESoundStart', 'ISpRecoGrammar2',
    'eLEXTYPE_PRIVATE6', 'DISPID_SRCEAdaptation', 'DISPID_SGRName',
    'DISPID_SRRTimes', 'DISPID_SPPNumberOfElements',
    'DISPID_SGRAddResource', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SVSFIsXML', 'DISPID_SREmulateRecognition',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRSetPropertyString', 'ISpeechPhraseInfoBuilder',
    'DISPID_SLWs_NewEnum', 'ISpPhraseAlt', 'eWORDTYPE_DELETED',
    'DISPID_SPEEngineConfidence', 'DISPID_SPEsCount',
    'DISPID_SABIBufferSize', 'SPPS_SuppressWord',
    'SAFT22kHz8BitStereo', 'SAFT22kHz16BitStereo',
    'SAFTADPCM_11kHzMono', 'ISpeechDataKey',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPLO_DYNAMIC',
    'IInternetSecurityMgrSite', 'SPSNoun', 'SREPhraseStart',
    'DISPID_SVEEnginePrivate', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SVGetProfiles', 'SPAUDIOBUFFERINFO', 'SPSHORTCUTTYPE',
    'DISPID_SPIProperties', 'DISPID_SRRTStreamTime',
    'eLEXTYPE_PRIVATE3', 'SPINTERFERENCE', 'ISpeechAudio',
    'DISPID_SPRDisplayAttributes', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SVP_20', 'DISPID_SpeechLexiconWord', 'DISPID_SGRId',
    'DISPID_SVEVoiceChange', 'SVP_1', 'SGDisplay',
    'SpeechGrammarState', 'eLEXTYPE_RESERVED9', 'SAFT32kHz8BitStereo',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SRSAudioStatus',
    'SPINTERFERENCE_LATENCY_WARNING', 'SREHypothesis',
    'DISPID_SGRSTPropertyValue', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SPEActualConfidence', 'ISpStream', 'SPPHRASEELEMENT',
    'DISPID_SPPBRestorePhraseFromMemory', 'SVPNormal',
    'DISPID_SpeechPhraseInfo', 'SDTAll', 'SpeechTokenValueCLSID',
    'SpMMAudioIn', 'ISpeechFileStream', 'DISPID_SVSInputWordLength',
    'eLEXTYPE_LETTERTOSOUND', 'SPEI_PROPERTY_STRING_CHANGE',
    'SpeechVoiceEvents', 'DISPID_SPRuleId', 'DISPID_SRRGetXMLResult',
    'SPEI_MIN_SR', 'DISPID_SpeechPhraseElements',
    'SpeechCategoryVoices', 'ISpeechObjectTokenCategory',
    'DISPID_SGRSRule', 'SPSMF_UPS', 'eLEXTYPE_PRIVATE9',
    'eWORDTYPE_ADDED', 'DISPID_SVSpeak', 'LONG_PTR',
    'SPINTERFERENCE_NOISE', 'SVP_18', 'tagSTATSTG',
    'DISPID_SPPParent', 'SPSHT_EMAIL', 'SPRST_ACTIVE_ALWAYS',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SAVolume',
    'SVSFVoiceMask', 'SAFT12kHz16BitStereo', 'SAFT48kHz8BitStereo',
    'SRSEDone', '_ISpeechVoiceEvents', 'DISPID_SVAudioOutputStream',
    'SPPS_Modifier', 'SpeechAddRemoveWord', 'SAFT12kHz16BitMono',
    'SSTTDictation', 'SPPS_NotOverriden', 'SPEI_RESERVED1',
    'DISPID_SPPsItem', 'DISPID_SVEPhoneme',
    'DISPID_SpeechPhoneConverter', 'SASClosed', 'SPEI_REQUEST_UI',
    'SPCT_SUB_DICTATION', 'DISPID_SpeechLexiconProns',
    'ISpeechBaseStream', 'DISPID_SDKEnumKeys',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SGRsFindRule',
    'DISPID_SRCERequestUI', 'ISpNotifySource',
    'DISPID_SWFESamplesPerSec', 'SpeechAudioState',
    'DISPID_SGRSTsCount', 'SpObjectTokenCategory',
    'SpeechRecoProfileProperties', 'ISpPhrase', 'SDTPronunciation',
    'SRTExtendableParse', 'DISPID_SVSVisemeId', 'SECFDefault',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRGetRecognizers',
    'SAFTGSM610_8kHzMono', 'SpeechCategoryRecognizers',
    'SPTEXTSELECTIONINFO', 'DISPID_SPISaveToMemory', 'SSFMCreate',
    'ISpeechPhraseInfo', 'DISPID_SpeechWaveFormatEx',
    'SPWORDPRONUNCIATIONLIST', 'SPPROPERTYINFO', 'SpLexicon',
    'SRAONone', 'DISPID_SpeechVoiceEvent', 'eLEXTYPE_RESERVED6',
    'DISPID_SVESentenceBoundary', 'DISPID_SRCVoicePurgeEvent',
    'SPAS_STOP', 'SPPS_LMA', 'DISPID_SDKCreateKey',
    'DISPID_SPRNumberOfElements', 'DISPID_SRGCmdSetRuleState',
    'SAFTADPCM_11kHzStereo', 'eLEXTYPE_USER_SHORTCUT',
    'SpeechRuleAttributes', 'SWTDeleted', 'SDTAlternates',
    'SpMMAudioEnum', 'SGDSActive', 'Speech_Default_Weight',
    'SAFTText', 'ISpeechPhraseRule', 'SpeechCategoryAppLexicons',
    'DISPID_SRCEPropertyStringChange', 'SPEI_SR_PRIVATE',
    'DISPID_SpeechFileStream', 'SPVPRI_NORMAL', 'SVP_5',
    'SPEI_INTERFERENCE', 'DISPID_SAFGuid', 'SAFT12kHz8BitStereo',
    'SINoSignal', 'DISPID_SVVoice', 'SDTAudio', 'SpeechLexiconType',
    'SpStream', 'SP_VISEME_7', 'SpWaveFormatEx', 'SP_VISEME_5',
    ...
    'ISpeechWaveFormatEx', 'DISPID_SRGCmdLoadFromObject',
    'SPVPRIORITY', 'SpeechFormatType', 'ISpeechRecognizer',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SPAsCount',
    'SpTextSelectionInformation', 'DISPID_SOTRemoveStorageFileName',
    'SPSVerb', 'DISPID_SRCEAudioLevel',
    'DISPID_SGRSAddWordTransition', 'SGRSTTDictation',
    'SVSFParseAutodetect', 'DISPID_SOTMatchesAttributes',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SRSInactive',
    'DISPID_SGRSTPropertyId', 'SGDSActiveUserDelimited', 'SRADynamic',
    'DISPID_SpeechBaseStream', 'DISPID_SRGSetTextSelection',
    'SPAUDIOSTATUS', 'DISPID_SRRSpeakAudio', 'SECLowConfidence',
    'SWTAdded', 'SpeechCategoryPhoneConverters', 'ISpObjectToken',
    'SPCT_DICTATION', 'SpeechCategoryAudioOut',
    'DISPID_SPEPronunciation', 'SREStreamEnd',
    'DISPID_SDKGetBinaryValue', 'SVEViseme', 'SINone',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPPS_Interjection',
    'SPEI_RESERVED3', 'DISPID_SRCESoundEnd', 'SpeechRunState',
    ...
    'DISPID_SRCEStartStream', 'SPAR_Low', 'SVEPrivate', 'SPAO_NONE',
    'SECFIgnoreWidth', 'SPSModifier', 'SVP_4', 'ISpRecognizer3',
    'DISPID_SCSBaseStream', 'DISPID_SGRsAdd', 'IEnumString',
    'DISPID_SVIsUISupported', 'eLEXTYPE_PRIVATE17',
    'ISpObjectWithToken', 'SVSFIsNotXML', 'DISPID_SRCEEndStream',
    'SRAInterpreter', 'SVF_None', 'ISpNotifyTranslator',
    'SPEI_VOICE_CHANGE', 'eLEXTYPE_PRIVATE11', 'SpeechVoicePriority',
    'SPSNotOverriden', 'SRTStandard', 'SVP_12', 'ISpeechLexiconWords',
    'SPAS_RUN', 'STCLocalServer', 'SAFTTrueSpeech_8kHz1BitMono',
    'SVP_17', 'SPRULE', 'eLEXTYPE_PRIVATE15', 'SVSFPersistXML',
    'STCInprocHandler', 'DISPID_SPPId', 'DISPID_SRIsUISupported',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFT8kHz8BitMono',
    'DISPID_SVAudioOutput'
]

_check_version('1.1.14', 1652328108.305996)
